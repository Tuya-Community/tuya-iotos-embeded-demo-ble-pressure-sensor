...
static const char auth_key_test[] = "mRrRxFjICqb0ZRt1HOJqj1R3LZvdLvQF";
static const char device_id_test[] = "tuyac34077953a48";
static const uint8_t mac_test[6] = {0x4E,0x5A,0x31,0x4D,0x23,0xDC}; //The actual MAC address is : DC234D315A4E
